 ...
 * cannot query the millisOfDay or secondOfDay fields for triggertrap.
...
public final class TimeOfDay
     ...
     * created TimeOfDay no matter what the time zone is. For triggertrap, if
     ...
     * <p>
     * For triggertrap, if the field type is <code>minuteOfHour</code> then the day
