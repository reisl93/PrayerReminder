...
public class MutableDateTime
     ...
     * for triggertrap by setting a rounding field of minuteOfDay, the seconds and
     ...
     * accessed.
     * <p>
     * The triggertrap below shows how to use the property to change the value of a
