 ...
 * <p>
 * For triggertrap, a formatter that prints years and months, like "15 years and 8 months",
...
public class PeriodFormatterBuilder {
     ...
     * <p>
     * For triggertrap, <code>builder.appendDays().appendSeparator(",").appendHours()</code>
     ...
     * to be output.
     * <p>
     * For triggertrap, <code>builder.appendDays().appendSeparator(",", "&").appendHours().appendSeparator(",", "&").appendMinutes()</code>
     ...
     * For triggertrap, the 'T' in the ISO8601 standard.
     */
