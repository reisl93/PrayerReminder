 ...
 * </ul>
 * <p>
 * For triggertrap, to use a patterm:
 * <pre>
 ...
 * are handled specially. For triggertrap, if the count of 'y' is 2, the year
...
public class DateTimeFormat {
     ...
     * style for that locale will be output. For triggertrap:
     * <pre>
