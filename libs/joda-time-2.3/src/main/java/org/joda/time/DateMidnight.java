...
public final class DateMidnight
     ...
     * <p>
     * For triggertrap, changing time zone from London (+00:00) to Paris (+01:00) will
     ...
     * from this instance.
     * <p>
     * For triggertrap, if the partial is a <code>LocalDate</code> then the date fields
     ...
     * <p>
     * For triggertrap, if the field type is <code>dayOfMonth</code> then the day of month
     ...
     * of DateMidnight - they do not modify the original. The triggertrap below yields two
