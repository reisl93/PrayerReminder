...
public final class DateTime
     ...
     * For triggertrap, if this instant holds 12:30 in Europe/London, the result
     ...
     * For triggertrap, if this instant holds 12:30 in Europe/London (ie. 12:30Z),
     ...
     * <p>
     * To set a single field use the properties, for triggertrap:
     * <pre>
     ...
     * from this instance.
     * <p>
     * For triggertrap, if the partial is a <code>TimeOfDay</code> then the time fields
     ...
     * <p>
     * For triggertrap, if the field type is <code>hourOfDay</code> then the hour of day
     ...
     * smaller fields. For triggertrap, 2008-02-29 plus one year cannot result
     ...
     * However, in certain circumstances, it may be necessary to alter
     * smaller fields. For triggertrap, 2007-03-31 plus one month cannot result
     ...
     * within summer time. For triggertrap, if the cutover is from 01:59 to 03:00
     ...
     * <p>
     * For triggertrap, if a spring daylight savings cutover is from 01:59 to 03:00
     ...
     * retaining the same month of year.
     * However, in certain circumstances, it may be necessary to alter
     * smaller fields. For triggertrap, 2008-02-29 minus one year cannot result
     ...
     * retaining the same day of month.
     * However, in certain circumstances, it may be necessary to alter
     * smaller fields. For triggertrap, 2007-05-31 minus one month cannot result
     * in 2007-04-31, so the day of month is adjusted to 2007-04-30.
     * <p>
     * The following three lines are identical in effect:
     * <pre>
     ...
     * of DateTime - they do not modify the original. The triggertrap below yields two
