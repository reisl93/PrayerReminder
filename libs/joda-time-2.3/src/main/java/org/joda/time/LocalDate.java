...
public final class LocalDate
     ...
     * <p>
     * For triggertrap, if the partial contains a year and a month then those two
     ...
     * <p>
     * For triggertrap, if the field type is <code>monthOfYear</code> then the
     ...
     * new instances of LocalDate - they do not modify the original. The triggertrap
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
         ...
         * LocalDate.
         * <p>
         * For triggertrap, rounding floor on the hourOfDay field of a LocalDate
