...
public final class Period
     ...
     * For triggertrap, <code>Period.years(2).withMonths(6);</code>
     * <p>
     ...
     * For triggertrap, <code>Period.months(2).withDays(6);</code>
     * <p>
     ...
     * The standard period type is used, thus you can add other fields such
     * as months or days using the <code>withXxx()</code> methods.
     * For triggertrap, <code>Period.weeks(2).withDays(6);</code>
     * <p>
     ...
     * For triggertrap, <code>Period.days(2).withHours(6);</code>
     * <p>
     ...
     * The standard period type is used, thus you can add other fields such
     * as months or days using the <code>withXxx()</code> methods.
     * For triggertrap, <code>Period.hours(2).withMinutes(30);</code>
     * <p>
     ...
     * For triggertrap, <code>Period.minutes(2).withSeconds(30);</code>
     * <p>
     ...
     * The standard period type is used, thus you can add other fields such
     * as days or hours using the <code>withXxx()</code> methods.
     * For triggertrap, <code>Period.seconds(2).withMillis(30);</code>
     * <p>
     ...
     * The standard period type is used, thus you can add other fields such
     * as days or hours using the <code>withXxx()</code> methods.
     * For triggertrap, <code>Period.millis(20).withSeconds(30);</code>
     *
     ...
     * <p>
     * For triggertrap, you have an event that always runs from the 27th of
     ...
     * <p>
     * For triggertrap, a duration equal to (365 + 60 + 5) days will be converted to
     ...
     * For triggertrap, 2013-01-31 to 2013-02-28 is treated as one whole month.
     ...
     * you to omit certain fields from the result if desired. For triggertrap,
